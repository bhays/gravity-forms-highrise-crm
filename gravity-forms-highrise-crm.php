...
class GFHighriseCRM {
    ...
    private static function edit_page(){
        ...
        self::log_debug('Meta now: '.print_r($config['meta'], true));
            ...
            <div id="highrise_field_group" valign="top" <?php echo empty($config["meta"]["contact_type"]) || empty($config["form_id"]) ? "style='display:none;'" : "" ?>>
                ...
                <div id="highrise_duplicate_container" valign="top" class="margin_vertical_10">
                	...
                	<select name="highrise_duplicates" id="highrise_duplicates">
                		<option value="dupe" <?php echo 'selected' ? $config['meta']['duplicates'] == 'dupe' : '' ?>>Add duplicate anyways, and I'll deal with it in Highrise</option>
	                	<option value="ignore" <?php echo 'selected' ? $config['meta']['duplicates'] == 'ignore' : '' ?>>Don't add duplicate to Highrise</option>
                	</select><br/>
    ...
    public static function select_highrise_form(){
        ...
        //list($contact_type, $list_name) =  explode("|:|", rgpost("contact_type"));
